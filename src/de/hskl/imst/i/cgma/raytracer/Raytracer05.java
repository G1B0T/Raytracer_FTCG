...
public class Raytracer05 implements IRayTracerImplementation {
    ...
    private Raytracer05() {
	    ...
	    // gui.addObject(BinarySTLImporter.loadBinarySTL(new File("data/test.stl")));
		// gui.addObject(RTFileReader.read(T_Mesh.class, new File("data/ikugel2.dat")));
...
//    				 minMaterialN= mesh.materialsN[matIndex];
    	...
    	if ((Math.abs(ai[0]+ai[1]+ai[2]-a))<1.0e-3f)
    	    return true;
